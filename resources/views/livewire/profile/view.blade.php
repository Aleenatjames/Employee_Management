...
<div class="flex flex-col lg:flex-row justify-between my-16 mx-3 h-auto dark:bg-gray-200">
      <div class="flex flex-col sticky top-0 z-5 mt-5 w-full">
        <div class=" border-gray-800 dark:bg-gray-800 shadow-md hover:shodow-lg  p-4">
            ...
            <div class="flex-auto sm:ml-5 justify-evenly">
              <div class="flex items-center justify-between sm:mt-2">
                <div class="flex items-center">
                  <div class="flex flex-col">
                    <div class="w-full flex-none text-lg text-gray-500 font-bold leading-none">{{$employee->name}}</div>
                    <div class="flex-auto text-gray-400 my-1">
                      <span class="mr-3 text-gray-800 ">{{$employee->designation}}</span><span class="mr-3 border-r border-gray-600  max-h-0"></span><span>{{$employee->email}}</span>
                    </div>
                  </div>
                </div>
              ...
              <div class="flex flex-row items-center">
                ...
                <div class="flex-1 inline-flex   items-center ml-2 space-x-2">
                  <a hre="https://www.behance.net/ajeeshmon" target="_blank"><svg class=" cursor-pointer w-5 h-5 p-1   hover:bg-blue-500 hover:text-white transition ease-in duration-300" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48" viewBox="0 0 172 172" style=" fill:#4a90e2;">
                  ...
                  <a hre="https://www.linkedin.com/in/ajeeshmon" target="_blank"><svg class="cursor-pointer w-5 h-5 p-1   hover:bg-blue-500 hover:text-white transition ease-in duration-300" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 172 172" style=" fill:#ffffff;">
                      <g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal">
                        <path d="M0,172v-172h172v172z" fill="none"></path>
                        <g fill="#ffffff">
                  ...
                  <a hre="https://twitter.com/ajeemon?lang=en" target="_blank"><svg class="cursor-pointer w-5 h-5 p-1   hover:bg-blue-400 hover:text-white transition ease-in duration-300" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24" height="24" viewBox="0 0 172 172" style=" fill:#ffffff;">
                      <g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal">
                        <path d="M0,172v-172h172v172z" fill="none"></path>
                        <g fill="#ffffff">
      ...
      <div class="grid grid-cols-12 gap-4 ">
        <div class="col-span-12 sm:col-span-4">
          <div class="p-4 relative   border-gray-800 dark:bg-gray-800 shadow-md hover:shodow-lg ">
      ...
      <div class="grid gap-4 grid-cols-1 md:grid-cols-2">
        ...
        <!--confirm modal-->
        <div class="flex flex-col p-4 relative items-center justify-center  border-gray-800 dark:bg-gray-800 shadow-md hover:shodow-lg ">
          <div class="">
            ...
            <div class="p-3  mt-2 text-center space-x-4 md:block">
              <button class="mb-2 md:mb-0 bg-gray-700 px-5 py-2 text-sm shadow-sm font-medium tracking-wider border-2 border-gray-600 hover:border-gray-700 text-gray-300 rounded-full hover:shadow-lg hover:transition ease-in duration-300">
                Cancel
              </button>
        ...
        <div class="flex flex-col space-y-4">
          <!-- elements 1 -->
          <div class="flex flex-col p-4 border-gray-800 dark:bg-gray-800 shadow-md hover:shodow-lg  cursor-pointer transition ease-in duration-500  transform hover:scale-105">

            <div class="flex items-center justify-between">
              <div class="flex items-center mr-auto">

                <div class="inline-flex w-12 h-12"><img src="https://tailwindcomponents.com/storage/avatars/njkIbPhyZCftc4g9XbMWwVsa7aGVPajYLRXhEeoo.jpg" alt="aji" class=" relative w-12 h-12 object-cover "><span class="animate-ping absolute w-12 h-12 inline-flex border-2  border-green-400 opacity-75"></span>
                  <span></span>
                </div>
          ...
          <div class="flex flex-col p-4 border-gray-800 dark:bg-gray-800 shadow-md hover:shodow-lg  cursor-pointer transition ease-in duration-500  transform hover:scale-105">
            ...
            <div class="flex items-center justify-between">
              <div class="flex items-center mr-auto">
                ...
                <div class="inline-flex w-12 h-12"><img src="https://tailwindcomponents.com/storage/avatars/njkIbPhyZCftc4g9XbMWwVsa7aGVPajYLRXhEeoo.jpg" alt="aji" class=" relative p-1 w-12 h-12 object-cover "><span class="absolute w-12 h-12 inline-flex border-2  border-green-400 opacity-75"></span>
                  <span></span>
                </div>
          ...
          <div class="flex flex-col p-4 border-gray-800 dark:bg-gray-800 shadow-md hover:shodow-lg  cursor-pointer transition ease-in duration-500  transform hover:scale-105">
            <div class="flex items-center justify-between">
              <div class="flex items-center mr-auto">
                <div class="inline-flex w-12 h-12"><img src="https://tailwindcomponents.com/storage/avatars/njkIbPhyZCftc4g9XbMWwVsa7aGVPajYLRXhEeoo.jpg" alt="aji" class=" relative p-1 w-12 h-12 object-cover "><span class="absolute w-12 h-12 inline-flex border-2  border-gray-600 opacity-75"></span>
                  <span></span>
                </div>
          ...
          <div class="flex flex-col p-4 border border-gray-800 dark:bg-gray-800 shadow-md hover:text-green-500 text-gray-400 hover:shodow-lg  transition ease-in duration-500  transform hover:scale-105 cursor-pointer">
            <div class="flex items-center justify-between">
              <div class="flex items-center mr-auto">
                <div class="-space-x-5 flex ">
                  <img src="https://tailwindcomponents.com/storage/avatars/njkIbPhyZCftc4g9XbMWwVsa7aGVPajYLRXhEeoo.jpg" alt="aji" class=" relative p-1 w-12 h-12 object-cover  border-2 border-gray-600 bg-gray-800">
                                      <img src="https://tailwindcomponents.com/storage/avatars/njkIbPhyZCftc4g9XbMWwVsa7aGVPajYLRXhEeoo.jpg" alt="aji" class=" relative p-1 w-12 h-12 object-cover  border-2 border-gray-600 shadow">
                </div>
...
<svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 ml-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
        ...
        <div class="flex flex-col justify-center p-4 border-gray-800 dark:bg-gray-800 shadow-md hover:shodow-lg ">
          <div class="flex items-center justify-between">
            <div class="flex items-center">
              <div class="flex flex-col">
        ...
        <div class="flex flex-col p-4 border-gray-800 dark:bg-gray-800 shadow-md hover:shodow-lg ">
          <div class="flex">
            <img src="https://images.unsplash.com/photo-1575390730294-dfc5efa5250b?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=255&q=80" alt="Just a flower" class=" w-16  object-fit  h-16 ">
       ...
       <div class="flex flex-col">
          <div class="lg:w-3/5 p-4 border-gray-800 dark:bg-gray-800 shadow-md hover:shodow-lg ">
            <div class="flex-none lg:flex">
              <div class=" h-full w-full lg:h-36 lg:w-36   lg:mb-0 mb-3">
                <img src="https://images.unsplash.com/photo-1515362778563-6a8d0e44bc0b?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1500&q=80" alt="unsplash images" class=" w-full  object-scale-down lg:object-cover  lg:h-36 ">
              </div>
              <div class="flex-auto lg:ml-3 justify-evenly py-2">
                ...
                <div class="flex my-3 border-t border-gray-800 dark:bg-gray-800 "></div>
