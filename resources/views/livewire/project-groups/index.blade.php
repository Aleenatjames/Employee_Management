            ...
            <div class="mt-20 bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                ...
                <div class="flex items-center justify-between p-4">
                    ...
                    <div class="flex space-x-3">
                        <a href="{{ route('employee.project-groups.create') }}" class="px-4 py-2 bg-blue-500 dark:bg-blue-600 text-white dark:text-gray-100 rounded-lg hover:bg-blue-600 dark:hover:bg-blue-700">Create</a>
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 dark:text-gray-100 uppercase bg-gray-50 dark:bg-gray-700">
                            <tr>
                                ...
                                <th wire:click="sortBy('isProject')" class="cursor-pointer px-4 py-2">Is Project?</th>
                        ...
                        <tbody>
                            ...
                            <tr class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-2 flex items-center">
                                    <a href="{{ route('employee.project-groups.edit', $group->id) }}" class="px-3 py-1 mr-2 bg-gray-500 dark:bg-gray-600 text-white dark:text-gray-100 rounded hover:bg-gray-600 dark:hover:bg-gray-700">Edit</a>
                                    <button onclick="confirm('Are you sure you want to delete this group?') || event.stopImmediatePropagation()" wire:click="delete({{ $group->id }})" class="px-3 py-1 bg-red-500 dark:bg-red-600 text-white dark:text-gray-100 rounded hover:bg-red-600 dark:hover:bg-red-700">Delete</button>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
